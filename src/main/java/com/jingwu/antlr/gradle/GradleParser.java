...
public class GradleParser extends Parser {
	...
	public static class LineContext extends ParserRuleContext {
		public List<TerminalNode> Id() { return getTokens(GradleParser.Id); }
		public TerminalNode Id(int i) {
			return getToken(GradleParser.Id, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GradleListener ) ((GradleListener)listener).enterLine(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GradleListener ) ((GradleListener)listener).exitLine(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GradleVisitor ) return ((GradleVisitor<? extends T>)visitor).visitLine(this);
