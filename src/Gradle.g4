...
echoStatement: ECHO Id* sep* ;
assigneStatement: (variable EqualSign Id)+ sep* ;
taskStatement: Id+ block+ ;

block: LBRACE sep? statements*? RBRACE;
...
Id                  : (LETTER|DEC_DIGIT|UNDERLINE|DOT|SUB)+                       ;
//Variable            : (UNDERLINE|LETTER|DEC_DIGIT)+                     ;
//VariableValue       : EqualSign Id                                      ;
